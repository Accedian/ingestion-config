...
This folder contains overlay-style sensor-collector additions for Juniper JTI OpenConfig telemetry.
...
- overlay keys:
  - `juniper_telemetry_interface`
  - `juniper_telemetry_interface_queues`
...
Use this overlay when the collector must process Juniper interface and queue metrics with the expected delta/rate behavior.
